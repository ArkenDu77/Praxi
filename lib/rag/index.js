...
const DEFAULT_MAX_PER_DOC = 2;   // diversité : évite 8 passages du même article
...
//
// Le lexical garde un poids réel : c'est lui qui rattrape les noms de molécules,
// les scores (PASI, SCORAD, DLQI) et les acronymes, que les embeddings captent mal.
const DEFAULT_WEIGHTS = { vector: 2, lexical: 1 };
...
module.exports = { ragIngest, ragSearch, ragStats, ragCollections, store, embeddings, DEFAULT_WEIGHTS };
