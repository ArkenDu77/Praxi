...
async function ragSearch({ collection, query, topK = DEFAULT_TOP_K, maxPerDoc = DEFAULT_MAX_PER_DOC, weights = {} }) {
  ...
  const fused = reciprocalRankFusion(
    ...
    [weights.vector == null ? 1 : weights.vector, weights.lexical == null ? 1 : weights.lexical]
  );
...
module.exports = { ragIngest, ragSearch, ragStats, ragCollections, store, embeddings };
