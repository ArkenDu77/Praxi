  ...
  dermatologie: {
    ...
    sources: {
      pubmed: {
        ...
        //
        // ⚠ Prévoir des requêtes orientées SÉMIOLOGIE, pas seulement traitement.
        // Un médecin qui demande un avis décrit une lésion sans nommer la maladie ;
        // seuls les documents qui décrivent la présentation clinique peuvent être
        // atteints par une telle requête. Les avis de remboursement HAS, eux, ne
        // contiennent aucune sémiologie et restent hors de portée — c'est la
        // raison pour laquelle enrichir le corpus HAS n'avait rien changé.
        queries: [
          ...
          // Psoriasis — versant clinique et diagnostique, ajouté après avoir
          // constaté qu'un cas décrit par sa sémiologie n'atteignait aucune
          // source psoriasis. Ramène « Pathophysiology, Clinical Presentation… »,
          // « Pathogenesis and clinical features of psoriasis », « Psoriasis and
          // Papulosquamous Disorders ».
          '"Psoriasis/diagnosis"[MeSH] AND (review[pt] OR guideline[pt]) AND ("2015"[dp] : "3000"[dp])',
          '("Psoriasis"[MeSH] OR "Skin Diseases, Papulosquamous"[MeSH]) AND ("diagnosis, differential"[MeSH] OR differential diagnosis[ti]) AND ("2015"[dp] : "3000"[dp])',
          '"Psoriasis/classification"[MeSH] OR ("Psoriasis"[MeSH] AND (clinical features[ti] OR phenotype[ti] OR variants[ti]))',
          '"Skin Diseases, Papulosquamous"[MeSH] AND review[pt] AND ("2015"[dp] : "3000"[dp])',
